...
-ESERCIZI 2 & 3:
Le soluzioni dell'esercizio 2 e 3 (+ alcuni file ausiliari) sono nella sottocartella "./my_midterm/midterm_ium/". E' possibile sia aprire la soluzione di Visual Studio "my_midterm.sln" che i singoli file sorgenti.

I nomi dei files di soluzione del secondo e del terzo esercizio sono, rispettivamente, "es2.fsx" ed "es3.fsx". 

Eseguire i files nell'interprete f#.
...
Dato l'elevato numero di chiamate ricorsive (1 per ogni pixel contenuto nell'arrea del poligono), un'implementazione ricorsiva dell'algoritmo puo' causare uno stack overflow anche per immagini di dimensioni modeste. Per questo motivo, nell'esercizio 2 si utilizza un'implementazione
